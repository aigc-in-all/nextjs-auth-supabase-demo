            ...
            <div className="shadow-lg rounded-md p-6 border bg-white">
                ...
                <form className="flex flex-col gap-4 mt-4">
                    <div className="flex flex-col gap-1">
                        <input type="email"
                            id="email"
                            className="px-3 py-2 text-sm text-slate-400 border border-s-amber-300"
                            value={email}
                    ...
                    <div className="flex flex-col gap-1">
                        <input type="password"
                            ...
                            className="px-3 py-2 text-sm text-slate-400 border border-slate-300"
                    ...
                    <button type="button"
                        ...
                        onClick={async (e) => {
                            ...
                            if (error)
                                ...
                                setAlert({ type: "info", msg: "Check your email!" })
                        }}>
                        Register
                    </button>
                </form>
...
const Alert: React.FC<AlertProps> = ({ type, msg }) => {
    ...
    return (
        <div className={`text-sx py-2 px-2 flex gap-2 mb-2 w-72 border rounded-md ${style}`}>
            <strong>{type}: </strong>
            <span>{msg}</span>
        </div>
    )
